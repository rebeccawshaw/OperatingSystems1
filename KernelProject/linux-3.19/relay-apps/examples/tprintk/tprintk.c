/*
 * tprintk - log tprintk output to per-cpu files
 *
 ...
 * ./tprintk [-b subbuf-size -n n_subbufs]
 *
...
char *app_dirname = "/debug/tprintk";
...
{
	fprintf(stderr, "tprintk [-b subbuf_size -n n_subbufs]\n");
	exit(1);
}
